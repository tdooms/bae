...
class Muon(torch.optim.Optimizer):
    ...
    """
    def __init__(self, muon_params, lr=0.02, weight_decay=0.01, momentum=0.95, nesterov=True, ns_steps=5,
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in params:
                ...
                p.data.add_(p.data, alpha=-lr*group['weight_decay']) # Add this line for weight decay
